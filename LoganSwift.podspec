Pod::Spec.new do |s|
  ...
  s.swift_version = "4.2"
  s.description   = <<-DESC
  LoganSwift is a pure Swift implemented kit on top of Clogan.
                   DESC
  ...
  s.pod_target_xcconfig = {'SWIFT_INCLUDE_PATHS' => '$(SRCROOT)/Logan/Logan/Clogan/**','LIBRARY_SEARCH_PATHS' => '$(SRCROOT)/Logan/Logan/LoganSwift/'}
